...
namespace RC.Game.Protocol
{
	...
	public class _PACKET_LV_BATTLE_ENTITY_AWAKE : Packet
	{
		...
		public _PACKET_LV_BATTLE_ENTITY_AWAKE() : base( 100, 3, false )
		{
		}

		public _PACKET_LV_BATTLE_ENTITY_AWAKE( _DTO_ulong dto ) : base( 100, 3, false )
		{
			this.dto = dto;
		}

		public _PACKET_LV_BATTLE_ENTITY_AWAKE( ulong value ) : base( 100, 3, false )
		{
