...
namespace RC.Game.Protocol
{
	...
	public class _PACKET_LV_BATTLE_KEYFRAME : Packet
	{
		...
		public _PACKET_LV_BATTLE_KEYFRAME() : base( 0, 0 )
		{
		}

		public _PACKET_LV_BATTLE_KEYFRAME( _DTO_keyframe dto ) : base( 0, 0 )
		{
			this.dto = dto;
		}

		public _PACKET_LV_BATTLE_KEYFRAME( int frame ) : base( 0, 0 )
		{
