...
namespace RC.Game.Protocol
{
	...
	public class _PACKET_LV_BATTLE_ENTITY_DESTROY : Packet
	{
		...
		public _PACKET_LV_BATTLE_ENTITY_DESTROY() : base( 100, 5, false )
		{
		}

		public _PACKET_LV_BATTLE_ENTITY_DESTROY( _DTO_ulong dto ) : base( 100, 5, false )
		{
			this.dto = dto;
		}

		public _PACKET_LV_BATTLE_ENTITY_DESTROY( ulong value ) : base( 100, 5, false )
		{
