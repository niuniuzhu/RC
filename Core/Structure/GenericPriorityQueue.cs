        ...
        where TPriority : IComparable<TPriority>
    {
        ...
        private void CascadeUp(TItem node)
        {
            ...
            if (node.queueIndex > 1)
            {
                ...
                TItem parentNode = this._nodes[parent];
        ...
        private void CascadeDown(TItem node)
        {
            ...
            TItem childLeft = this._nodes[childLeftIndex];
            if(this.HasHigherPriority(childLeft, node))
            {
                ...
                TItem childRight = this._nodes[childRightIndex];
        ...
        {
            var cmp = this._comparer(higher.priority, lower.priority);
        ...
        public TItem Dequeue()
        {
            ...
            TItem formerLastNode = this._nodes[this._numNodes];
